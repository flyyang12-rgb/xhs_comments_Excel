...
function makeZip(files) {
  ...
  for (const [name, content] of Object.entries(files)) {
    ...
    writeUint16(local, 10, dosTime(now));
    writeUint16(local, 12, dosDate(now));
    ...
    writeUint16(central, 12, dosTime(now));
    writeUint16(central, 14, dosDate(now));
...
function createWorkbookBlob(sheetName, rows) {
  const files = {
    ...staticFiles,
...
globalThis.createWorkbookBlob = createWorkbookBlob;
