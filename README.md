...
<p align="center">
  <strong>v1.2.4</strong> · Windows 64 位 · Chrome · 便携版
</p>
...
> 升级到 **1.2.4**：先关闭旧服务窗口，覆盖解压新版 RAR，再双击启动文件，并在扩展管理页点击「重新加载」。本次服务也有更新，必须重新启动。

1.2.4 精简启动窗口，移除路径复制；运行记录改为「开始采集 → 已采集几篇 → 采集完毕」。停止与失败保留简短提示，详细原因在插件内查看。保留评论逐页保存、回复去重计数和重复翻页保护。
