...
<p align="center">
  <strong>v1.2.0</strong> · Windows 64 位 · Chrome · 便携版
</p>
...
> 升级旧版时，先关闭旧服务窗口，再移除旧插件并加载新版，确认版本为 **1.2.0**。
...
先关闭旧签名服务窗口，再运行包内的启动文件。新版插件需要配合包内服务，不能继续使用旧签名服务。
...
登录过期时，在当前 Chrome 中重新登录小红书。如果界面仍是旧版，请检查加载路径，移除旧插件后，重新加载新版的 `xhs_chrome_extension` 文件夹。
