...
<p align="center">
  <strong>v1.2.1</strong> · Windows 64 位 · Chrome · 便携版
</p>
...
> 升级旧版时，先关闭旧服务窗口，再移除旧插件并加载新版，确认版本为 **1.2.1**。
...
提示缺少 `a1` 或 `web_session` 时，请在插件所在的同一个 Chrome 窗口完成登录，再刷新页面重试。其他浏览器或无痕窗口的登录态不共用。登录过期时，请重新登录小红书。如果界面仍是旧版，请检查加载路径，移除旧插件后，重新加载新版的 `xhs_chrome_extension` 文件夹。
